  ...
  return jobData ? (
    <>
      ...
      <div className="container min-h-screen flex flex-col py-10  px-4 2xl:px-20 mx-auto">
        <div className="bg-white text-black rounded-lg w-fll">
          <div className="flex justify-center md:justify-between items-center flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            ...
            <div className="w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5">
              ...
              {jobs
                ...
                .slice(0, 4) // Limit the results to 4 jobs
                .map((job) => (
                  <JobCard key={job._id} job={job} /> // Use job._id as the key
                ))}
            </div>
          </div>
        </div>
