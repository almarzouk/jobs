          ...
          (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span className="inline-flex items-center gap-2.5 bg-blue-50 border border-blue-200 px-4 py-2 rounded">
                    {searchFilter.title}
                    <img
                ...
                {searchFilter.location && (
                  <span className="inline-flex items-center gap-2.5 bg-red-50 border border-red-200 px-4 py-2 rounded ml-2">
                    {searchFilter.location}
                    <img
                      className="cursor-pointer"
                      src={assets.cross_icon}
          ...
          <div className="flex items-center justify-center space-x-2 mt-10">
            ...
            {Array.from({ length: Math.ceil(filteredJobs.length / 6) }).map(
              (_, index) => (
                ...
                >
                  <button
                    className={`w-10 h-10 flex items-center justify-center border border-gray rounded ${
                      currentPage === index + 1
